...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-powered exam preparation for Namibian NSSCO students. Generate quizzes, get explanations, and track your progress." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ExamPass AI — Ace Your NSSCO Exams" },
      { name: "twitter:description", content: "AI-powered exam preparation for Namibian NSSCO students. Generate quizzes, get explanations, and track your progress." },
